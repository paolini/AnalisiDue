...
\input{chapters/01_metrici}
\input{chapters/02_topologici}
\input{chapters/03_completezza}
\input{chapters/04_convergenza_uniforme}
\input{chapters/05_integrale}
\input{chapters/06_derivata}
\input{chapters/07_convergenza_integrale}


\section{Funzione di Weierstrass}
...
\input{chapters/08_frattali}
\input{chapters/90_storia}
