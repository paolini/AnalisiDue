\section{Esempi di calcolo di integrali multipli}

\subsection*{Coordinate polari}
Se la funzione integranda o il dominio di integrazione hanno una 
simmetria circolare può essere conveniente effettuare un cambio di
...
Calcoliamo l'area del cerchio di raggio $R$ centrato nell'origine, cioè l'integrale:
\[
\iint_{B_R(0)} 1 \, dx\,dy.
\]
