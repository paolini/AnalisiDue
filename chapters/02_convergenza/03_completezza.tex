...
%
\begin{proof}
Visto che lo spazio è sequenzialmente compatto ogni successione di Cauchy
...
Sia $(X,d)$ uno spazio metrico e sia $A\subset X$ un sottoinsieme chiuso in $X$. 
Se $X$ è sequenzialmente compatto allora anche $A$ è compatto, 
se $X$ è completo allora anche $A$ è completo.
\end{theorem}
%
\begin{proof}
Se $X$ è sequenzialmente compatto da ogni successione in $A$ 
si può estrarre una sottosuccessione convergente ad un punto di $X$. 
