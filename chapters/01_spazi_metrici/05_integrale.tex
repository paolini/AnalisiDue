...
\begin{example}[la funzione $\Gamma$ Eulero]%
  ...
  In questo capitolo dimostreremo 
...
Visto che la funzione integranda $f(x,t)=e^{-t}t^{x-1}$,
...
\begin{theorem}[convergenza dominata caso continuo]
...
grazie al teorema di collegamento tra limite 
...
come si faceva ad Analisi Uno per dimostrare che l'integrale $\int_\pi^{+\infty} \frac{\sin x}{x}\, dx$ 
è convergente.
