...
\subsection{riparametrizzazioni}
...
Tale valore viene chiamato \emph{derivata metrica} di $u$ e si indica con $\abs{u'}$:
\[
...
Per ogni $t\in [a,b]$ esiste $x_n$ tale che
$\abs{t - x_n} < \delta$ e dunque,
per l'equicontinuità, si ha
\begin{align*}
