...
\[
\abs{\xi_\phi} = \xi_\phi \cdot \nu_\phi = \det(\nu_\phi, D\phi).
\]
Osserviamo che $\det(\nu_\phi, D\phi)$ è il volume del prisma retto di altezza unitaria costruito 
sul parallelepipedo generato dalle colonne di $D\phi$ e dunque è uguale all'area del parallelepipedo stesso, 
cioè, per il significato geometrico del determinante Jacobiano, si ha
\[
\abs{\xi_\phi} = \det(\nu_\phi, D\phi)
...
Pertanto se $v\in \RR^n$ è un vettore qualsiasi si ha
...
Se $\xi\colon A\subset \RR^n\to \RR^n$ è un campo vettoriale, 
posso definire il flusso di $\xi$ attraverso la superficie parametrizzata da $\phi$,
grazie a~\eqref{eq:493444}, come
\begin{align*}
  \int_\phi \xi \cdot \nu_\phi\, d\sigma
  &= \int_B (\xi \cdot \nu_\phi) \sqrt{\det ((D\phi)^t D\phi)}\, dx\\
  &= \int_B \det(\xi, D\phi)\, dx.
\end{align*}
Dunque se $\omega$ è la $(n-1)$-forma differenziale associata al campo vettoriale $\xi$
cioè:
\[
  \omega = \xi_1 \widehat{dx_1} + \dots + \xi_n \widehat{dx_n}
\]
***********************