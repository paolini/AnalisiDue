...
Se $V$ ha dimensione infinita non serve richiedere la continuità, 
...
Nel caso $n=m=1$, cioè $ f\colon A\subset \RR\to\RR^m$, $x\in A$,
...
\begin{example}\label{ex:48993}
  ...
  \]
  Visto che $\abs{xy} \le x^2+y2 = o(\sqrt{x^2+y^2})$
