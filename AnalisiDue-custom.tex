...
\newcommand{\Enclose}[1]{{\left[ #1 \right]}}
\newcommand{\ENCLOSE}[1]{{\left\{ #1 \right\}}}
\newcommand{\current}[1]{{\left\llbracket #1 \right\rrbracket}}
...
\newwrite\myauxfile
\immediate\openout\myauxfile=AnalisiDue.myaux
...
\newcommand{\myshorturl}[1]{http://paolini.github.io/AnalisiDue?#1}
