...
su ogni cubetto $E=Q^N_{\vec k}$, allora approssimando opportunamente 
...
Il procedimento di riduzione a scala di Gauss 
è un procedimento per cui possiamo trovare delle matrici 
